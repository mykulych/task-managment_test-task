...
const update_todo_status_dto_1 = require("./dto/update-todo-status.dto");
let TodosController = class TodosController {
    constructor(todosService) {
        this.todosService = todosService;
    }
    async getTodos(board_id) {
...
__decorate([
    ...
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_todo_status_dto_1.UpdateTodoStatusDto]),
    __metadata("design:returntype", Promise)
], TodosController.prototype, "changeTodoStatus", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], TodosController.prototype, "updateTodoOrder", null);
__decorate([
